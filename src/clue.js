...
function revealMystery(card) {
    const result = `${card.suspect.firstName} ${card.suspect.lastName} killed Mr. Boddy using the ${card.weapon.name} in the ${card.room.name}!`
return result;
}

revealMystery(card);
console.log(revealMystery(card))